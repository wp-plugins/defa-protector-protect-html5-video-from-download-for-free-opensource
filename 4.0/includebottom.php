...
$_SESSION['defa'.$matches['2']] = md5(time()."Defa Protector");
  return $matches[1] . $rootURL .$defa . "/defavid.php?defat=".$_SESSION['defat']."&defain=".$_SESSION['defa'.$matches['2'].$_SESSION['defat']]."&im=" .md5('Defa').base64_encode(base64_encode($matches['2']));
}
